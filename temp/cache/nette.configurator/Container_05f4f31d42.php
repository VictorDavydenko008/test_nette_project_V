<?php
// source: C:\Users\User\test_nette_project/config/common.neon
// source: C:\Users\User\test_nette_project/config/services.neon
// source: C:\Users\User\test_nette_project/config/local.neon
// source: array
...
class Container_05f4f31d42 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\Users\User\test_nette_project/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('C:\Users\User\test_nette_project/temp/cache');
	}


	public function createServiceContainer(): Container_05f4f31d42
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_05f4f31d42 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\User\test_nette_project/temp/cache/latte');
